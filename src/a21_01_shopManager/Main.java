    ...
    public static void main(String[] args) {
        ...
        while (option != 0) {
            if (option == 1) {
                ...
                System.out.println(shop.numProducts());
            } else if (option == 3) {
                ...
                System.out.println("Enter active (1.true, 2.false):");
                boolean isActive = scanner.nextInt() == 1;
                scanner.nextLine();

                System.out.println(
                        shop.addProduct(new Product(name, size, price, isActive))
                );
            } else if (option == 4) {
                ...
                System.out.println(
                        shop.updateProduct(id, new Product(name, size, price, isActive))
                );
            } else if (option == 5) {
                System.out.println("Enter ID:");
                int id = scanner.nextInt();
